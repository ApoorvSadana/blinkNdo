...
while True:
    ...
    for rect in rects:
        ...
        cv2.circle(frame, (cX_left, cY_left), 1, (0, 0, 0xFF), -1)
        cv2.circle(frame, (cX_right, cY_right), 1, (0, 0, 0xFF), -1)
        ...
        if isinstance(circles_left, np.ndarray):
            ...
            for i in circles_left[0, :]:
                ...
                cv2.circle(left_eye_image, (i[0], i[1]), i[2], (0,
                                                                0xFF, 0), 2)
        ...
        if isinstance(circles_right, np.ndarray):
            ...
            for i in circles_right[0, :]:
                ...
                cv2.circle(right_eye_image, (i[0], i[1]), i[2], (0,
                                                                 0xFF, 0), 2)
...
# ........ret,thresh_right = cv2.threshold(gray_right,THRESH_CONST,255,cv2.THRESH_BINARY_INV)
        ...
        if TOTAL == 1:
            ...
            os.system('python C:\\Users\\apoor\\OneDrive\\Documents\\GitHub\\blinkNdo\\phone_call_updated.py'
                      )
            phone_call_done = 1
